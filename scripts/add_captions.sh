...
CAPTIONS=(
  "0,3,眉アート行ってみた,60,white,0.58"
  "3,6,仕上がりがこちら,56,white,0.58"
  "7,10,もともとこんな感じで,56,white,0.58"
  "10,14,眉毛ほぼなかったんよ,56,white,0.58"
  "14,17,メイクで描くの毎日大変で,52,white,0.58"
  "17,20,ずっと悩んでた,56,white,0.58"
  "20,22,それがこうなりました,56,yellow,0.58"
  "22,25,ちょっと濃くて太くね？ww,52,white,0.58"
  "25,28,でもすっぴんでこの眉嬉しい,48,white,0.58"
  "28,32,経過また報告するね,52,0xFFA500,0.55"
  "28,32,フォローで見守ってて♡,54,0xFFA500,0.61"
)
